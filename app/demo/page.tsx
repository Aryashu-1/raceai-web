...
export default function DemoPage() {
  ...
  const [chatHistory, setChatHistory] = React.useState<
    Array<{ type: "user" | "jarvis"; message: string }>
  >([]);
  ...
  const handleContinueDemo = () => {
    ...
    speak(
      "Alright! I'll keep showing you what I can do. Remember, this is just a preview of the full experience."
    );
  };
        ...
        <div className="flex justify-between items-center p-6 border-b border-white/20">
          <div>
            ...
            <p className="text-blue-200 text-sm">
              Experience AI-assisted research • {3 - interactionCount} demo
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6">
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-4 max-w-4xl w-full mb-8">
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl p-6 text-center">
              ...
              <p className="text-blue-200 text-sm">
                Find relevant papers instantly with AI-powered search
              </p>
              <div className="mt-3 text-xs text-blue-400">
                Demo: Basic search only
              </div>
            </div>
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl p-6 text-center">
              <div className="text-3xl mb-3">📊</div>
              ...
              <p className="text-blue-200 text-sm">
                Track progress and get insights on your research
              </p>
              <div className="mt-3 text-xs text-blue-400">
                Full version: Advanced analytics
              </div>
            </div>
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-xl p-6 text-center">
              <div className="text-3xl mb-3">🤝</div>
              ...
              <p className="text-blue-200 text-sm">
                Work together with peers and mentors seamlessly
              </p>
              <div className="mt-3 text-xs text-blue-400">
                Full version: Real-time collaboration
              </div>
            </div>
          </div>
              ...
              {chatHistory.length === 0 ? (
                <div className="text-center">
                  <p className="text-blue-200 mb-4">
                    Try asking JARVIS something about research!
                  </p>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                    <button
                      onClick={() =>
                        setChatInput("Find papers on machine learning")
                      }
                    ...
                    <button
                      onClick={() =>
                        setChatInput("Help me write a literature review")
                      }
                      className="text-left p-2 rounded hover:bg-white/10 text-blue-300 hover:text-white transition-colors"
                    >
              ...
              <div className="bg-white/10 backdrop-blur-xl border border-blue-500/50 rounded-xl p-6 mb-4">
                <div className="text-center">
                  ...
                  <p className="text-blue-200 text-sm mb-4">
                    You've reached the demo limit. Sign up to get unlimited
                    access, personalized recommendations, and advanced research
                    tools.
                  </p>
          ...
          <div className="mt-8 text-center max-w-2xl">
            {interactionCount === 0 && (
              <p className="text-blue-300 text-sm">
                This demo shows basic functionality. Sign up to unlock
                personalized research assistance!
              </p>
            )}
            {interactionCount === 1 && (
              <p className="text-blue-300 text-sm">
                Enjoying the demo? Full members get unlimited conversations and
                advanced research tools.
              </p>
            )}
            {interactionCount === 2 && (
              <p className="text-blue-300 text-sm">
                One more demo interaction left. Sign up now to continue with
                unlimited access!
              </p>
            )}
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm text-blue-300 mt-4">
              <span
                className={cn(
                  interactionCount >= 1 ? "line-through opacity-50" : ""
                )}
              >
                ✓ Basic AI responses
              </span>
