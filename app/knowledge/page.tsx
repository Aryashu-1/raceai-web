...
export default function KnowledgeDiscoveryPage() {
  ...
  const fieldCategories = [
    ...
    { id: "quantum-computing", label: "Quantum Computing", icon: BookOpen },
    { id: "biotechnology", label: "Biotechnology", icon: Users },
    { id: "materials-science", label: "Materials Science", icon: Map },
    { id: "energy", label: "Energy", icon: Newspaper },
    { id: "healthcare", label: "Healthcare", icon: DollarSign },
  ];

  const sidebarCategories = [
    { id: "state-of-art", label: "State of the art research", icon: Star },
    { id: "topics-to-research", label: "Topics to research", icon: BookOpen },
    {
      id: "recent-groundbreaks",
      label: "Recent groundbreaks",
      icon: TrendingUp,
    },
    { id: "top-researchers", label: "Top Researchers", icon: Users },
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="p-6 border-b border-border">
          ...
          <p className="text-muted-foreground">
            Explore the latest research and discoveries in your field
          </p>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center space-x-3">
              ...
              <Button
                ...
                className="gradient-race-primary text-white px-6"
              >
                <Search size={16} />
              </Button>
            </div>
