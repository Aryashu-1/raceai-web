...
export function useARIAConversation() {
  ...
  return {
    ...
    think,
    excited,
    celebrate, // Export the celebrate function
  };
}
...
export function AriaAssistant({
  ...
  const { currentState, currentMessage, isTyping } = useARIAConversation();
  ...
  }, [currentMessage, showMessage, onMessageComplete]);
        ...
        <div
          className={cn(
            ...
            currentState === "speaking" &&
              "shadow-[0_0_30px_rgba(36,108,216,0.4)] scale-105",
            currentState === "thinking" &&
              "shadow-[0_0_25px_rgba(36,108,216,0.35)]",
            currentState === "excited" &&
              "shadow-[0_0_40px_rgba(36,108,216,0.5)] scale-110"
          )}
...
export { AriaAssistant as ARIAAssistant };
