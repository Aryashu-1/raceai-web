...
const actionCards = [
  {
    ...
    color: "bg-blue-500/10 border-blue-500/20 hover:bg-blue-500/20 hover:border-blue-500/30",
    route: "/explore",
  },
  {
    id: "ai-chat",
    ...
    color: "bg-blue-600/10 border-blue-600/20 hover:bg-blue-600/20 hover:border-blue-600/30",
    route: "/jarvis",
  },
  {
    id: "project",
    ...
    color: "bg-blue-700/10 border-blue-700/20 hover:bg-blue-700/20 hover:border-blue-700/30",
    route: "/projects",
  },
  {
    id: "connect",
    ...
    color: "bg-blue-800/10 border-blue-800/20 hover:bg-blue-800/20 hover:border-blue-800/30",
    route: "/collaborations",
  },
]

export default function WelcomeComplete({ userData, onComplete }: WelcomeCompleteProps) {
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        <div className="absolute top-8 right-8">
          <AriaAssistant size="medium" state="excited" message="Welcome to RACE AI!" showMessage={false} />
        </div>
        ...
        <div className="bg-card/80 backdrop-blur-sm rounded-2xl p-8 shadow-2xl border border-border/50">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-foreground mb-2">Welcome, {userData.firstName}!</h1>
            <p className="text-muted-foreground">Your research command center is ready. Here's what you can do:</p>
          </div>
          ...
          <div className="bg-muted/50 rounded-xl p-4 mb-6">
            <h3 className="font-semibold text-foreground mb-2">Quick Start Tips:</h3>
